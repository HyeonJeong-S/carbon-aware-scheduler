...
사용법 (저장소 루트에서):
    python -m load_balancer.framework.realtime_route --t-hour 200                    # jobs.csv 슬롯 재생
    python -m load_balancer.framework.realtime_route --t-hour 200 --alpha 0.5        # α 고정
...
from interface.carbon_history import BASE_TIME

from .config import EVAL_REGION_MAP, JOBS_CSV, L_NET_MAX_MS, REGIONS, load_latency_matrix
