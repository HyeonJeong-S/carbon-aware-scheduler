...
DATA_ROOT = BASE_DIR.parent / "data"               # 입력함 (1년 실데이터 단일 세트)

JOBS_CSV = DATA_ROOT / "jobs.csv"                  # 1년치 job 워크로드
LSTM_EVAL_DIR = DATA_ROOT / "lstm_eval"            # 리전별 eval_records (y_true/y_pred)
LATENCY_CSV = DATA_ROOT / "latency_8x8.csv"

# 출력: routed/ = 스케줄러 인계용(납품물) / results/ = 대시보드 분석용(내부)
RESULTS_DIR = BASE_DIR / "results"
ROUTED_DIR = BASE_DIR.parent / "routed"
