...
def run_simulation(jobs: list[dict[str, Any]], carbon_series: dict[str, list[float]], mode: str) -> list[dict[str, Any]]:
...
def run_all_modes(jobs: list[dict[str, Any]], carbon_series: dict[str, list[float]],
                  modes: list[str] | None = None) -> dict[str, list[dict[str, Any]]]:
