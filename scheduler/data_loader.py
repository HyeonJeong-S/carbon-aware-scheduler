...
def load_jobs_csv(csv_path: str | PathLike) -> list[dict[str, Any]]:
...
def load_jobs_with_assignment(jobs_csv: str | PathLike, assignment_csv: str | PathLike) -> list[dict[str, Any]]:
...
def load_routed_jobs_csv(csv_path: str | PathLike) -> list[dict[str, Any]]:
