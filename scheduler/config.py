...
from interface.regions import LB_TO_REGION as LB_TO_ZONE
from interface.regions import REGION_LABELS as ZONE_LABELS
from interface.regions import REGION_TO_ISO3 as ZONE_TO_ISO3
from interface.regions import REGIONS, to_region
