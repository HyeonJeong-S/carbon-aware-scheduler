...
#
# 사용법:
#   from carbon_forecast_lstm.carbon_forecast import load_all_models, get_carbon_forecast, get_forecast_at
...
def load_all_models(model_dir: str) -> tuple:
    ...
    logger.info("8개 리전 모델 + Scaler 로드 완료 (device=%s)", device)
...
def get_carbon_forecast(
    ...
    scalers:            dict,
    region_data:        dict,
    weather_scalers:    dict | None = None,
    generated_at:       str | None = None,
    future_weather_data: dict | None = None
) -> dict:
    """
