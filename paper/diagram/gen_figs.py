...
def fig_forecast():
    ...
    L.append(txt(26, 106.5, "64", size=7))
    ...
    # 보이는 게 더 중요").
    L += [rbox(20, 125, 175, 22, r=10),
          txt(29, 134, "출력  Ĉ", size=FT, bold=True),
          txt(50, 136, "r", size=5.8),
          txt(54, 134, "(t … t+24)", size=FT),
